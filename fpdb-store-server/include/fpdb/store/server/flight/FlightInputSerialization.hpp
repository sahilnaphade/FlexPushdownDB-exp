...
#ifndef FPDB_FPDB_STORE_SERVER_INCLUDE_FPDB_STORE_SERVER_FLIGHT_FLIGHTINPUTSERIALIZATION_HPP
#define FPDB_FPDB_STORE_SERVER_INCLUDE_FPDB_STORE_SERVER_FLIGHT_FLIGHTINPUTSERIALIZATION_HPP
...
public:
  ...
  static tl::expected<std::shared_ptr<FlightInputSerialization>, std::string> parse_json(const nlohmann::json& json);
...
public:
  ...
  static tl::expected<std::shared_ptr<FlightCSVInputSerialization>, std::string> parse_json(const nlohmann::json& json);
...
#endif // FPDB_FPDB_STORE_SERVER_INCLUDE_FPDB_STORE_SERVER_FLIGHT_FLIGHTINPUTSERIALIZATION_HPP
