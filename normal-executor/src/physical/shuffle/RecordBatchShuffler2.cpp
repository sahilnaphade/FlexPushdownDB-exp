...
#include <normal/executor/physical/shuffle/RecordBatchShuffler2.h>
...
RecordBatchShuffler2::make(const vector<string> &columnNames,
                           size_t numSlots,
...
tl::expected<vector<shared_ptr<TupleSet>>, string> RecordBatchShuffler2::toTupleSets() {
