...
#ifndef NORMAL_NORMAL_EXPRESSION_GANDIVA_INCLUDE_NORMAL_EXPRESSION_GANDIVA_SERIALIZATION_EXPRESSIONSERIALIZER_H
#define NORMAL_NORMAL_EXPRESSION_GANDIVA_INCLUDE_NORMAL_EXPRESSION_GANDIVA_SERIALIZATION_EXPRESSIONSERIALIZER_H
...
CAF_BEGIN_TYPE_ID_BLOCK(Expression, normal::caf::CAFUtil::Expression_first_custom_type_id)
...
struct variant_inspector_traits<ExpressionPtr> {
  ...
  static auto visit(F &&f, const value_type &x) {
    switch (type_index(x)) {
      ...
      case 4:
        return f(dynamic_cast<normal::expression::gandiva::Column &>(*x));
      case 5:
...
#endif //NORMAL_NORMAL_EXPRESSION_GANDIVA_INCLUDE_NORMAL_EXPRESSION_GANDIVA_SERIALIZATION_EXPRESSIONSERIALIZER_H
