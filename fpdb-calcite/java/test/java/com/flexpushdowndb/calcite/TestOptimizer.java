...
public class TestOptimizer {
  ...
  public void testCoHashJoin_TPCH_Q01() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/01.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q02() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/02.sql", true);
  }

  // has pushable co-located join
  @Test
  public void testCoHashJoin_TPCH_Q03() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/03.sql", true);
  }
  ...
  public void testCoHashJoin_TPCH_Q05() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/05.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q06() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/06.sql", true);
  }

  @Test
  // has pushable co-located join
  public void testCoHashJoin_TPCH_Q07() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/07.sql", true);
  }

  @Test
  // has pushable co-located join
  public void testCoHashJoin_TPCH_Q08() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/08.sql", true);
  }

  @Test
  // has pushable co-located join
  public void testCoHashJoin_TPCH_Q09() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/09.sql", true);
  }

  @Test
  // has pushable co-located join
  public void testCoHashJoin_TPCH_Q10() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/10.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q11() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/11.sql", true);
  }

  @Test
  // has pushable co-located join
  public void testCoHashJoin_TPCH_Q12() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/12.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q13() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/13.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q14() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/14.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q15() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/15.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q16() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/16.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q17() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/17.sql", true);
  }

  @Test
  // has pushable co-located join
  public void testCoHashJoin_TPCH_Q18() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/18.sql", true);
  }
  ...
  public void testCoHashJoin_TPCH_Q20() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/20.sql", true);
  }

  @Test
  // has pushable co-located join
  public void testCoHashJoin_TPCH_Q21() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/21.sql", true);
  }

  @Test
  public void testCoHashJoin_TPCH_Q22() throws Exception {
    testSingle("tpch-sf0.01-1-node-hash-part/parquet", "tpch/original/22.sql", true);
  }
