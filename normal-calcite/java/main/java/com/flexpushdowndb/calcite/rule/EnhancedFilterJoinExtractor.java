...
public final class EnhancedFilterJoinExtractor {
  ...
  public EnhancedFilterJoinExtractor(Filter filterRel, Join joinRel, FilterJoinRule.Predicate predicate) {
    ...
    // Canonicalize input conditions
    RexNode inputFilterConditionCanonicalized = SimpleExpressionCanonicalizer.canonicalizeExpression(
            inputFilterCondition, rexBuilder);
    RexNode inputJoinConditionCanonicalized = SimpleExpressionCanonicalizer.canonicalizeExpression(
            inputJoinCondition, rexBuilder);

    // Convert to Nnf
    RexNode inputFilterConditionNnf = SimpleExpressionCanonicalizer.toNnf(
            inputFilterConditionCanonicalized, rexBuilder);
    RexNode inputJoinConditionNnf = SimpleExpressionCanonicalizer.toNnf(
            inputJoinConditionCanonicalized, rexBuilder);
